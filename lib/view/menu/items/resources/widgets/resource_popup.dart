...
import 'package:happsales_crm/view/menu/items/resources/widgets/resource_alert.dart';
import 'package:popover/popover.dart';



class ResourcePopup extends StatelessWidget {
  const ResourcePopup({Key? key}) : super(key: key);
        ...
        child: ListView(
          ...
          children: [
            ...
            SizedBox(height: 15.h,),
             GestureDetector(
              onTap: (){
                showResourceSearchAlert(  context);
              },
               child: Row(
                 children: [
