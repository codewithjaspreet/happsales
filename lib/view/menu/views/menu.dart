...
import '../items/manager/views/manager.dart';
        ...
        child: GridView(
          ...
          children:   <Widget>[
            ...
            GestureDetector(
              ...
              child: const _buildGridItem(title : 'Resources', image: 'assets/resources.png' )),
            GestureDetector(
                onTap: () {
            ...
            GestureDetector(
              onTap: (){
                Get.to(() => const Managerpage());
              },
              child: const _buildGridItem(title : 'Manager', image: 'assets/manager.png' )),
