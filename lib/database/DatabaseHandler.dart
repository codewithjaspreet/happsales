    ...
    void AddDownSyncTables(String appUserId, String appUserGroupId)  async {
     ...
     void ResetPendingUpSyncIndexes() async {
        try {
            ...
            db.execute("UPDATE ${TablesBase.TABLE_ACCOUNTCATEGORY} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_ACCOUNT} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_ACCOUNTCATEGORYMAPPING} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_CONTACT} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_ACTIVITY} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_CUSTOMERMEETING} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_OPPORTUNITY} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_OPPORTUNITYPRODUCT} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_OPPORTUNITYPRODUCTDETAIL} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_OPPORTUNITYCONTACT} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_ACCOUNTADDRESS} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_ACCOUNTPHONE} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_ACCOUNTBUYINGPROCESS} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_ACCOUNTBUSINESSPLAN} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_ACCOUNTCOMPETITIONACTIVITY} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_NOTE} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_ACTIVITYTRAVEL} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_CHATUSERANDGROUP} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_CHATUSERGROUPMEMBER} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_CHATMESSAGE} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_APPUSERLOCATION} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_FIELDATTENDANCE} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_ACTIVITYPERMISSION} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_NOTEPERMISSION} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_OPPORTUNITYPERMISSION} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_REIMBURSEMENT} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_REIMBURSEMENTDETAIL} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_REMINDER} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_OPPORTUNITYTEAM} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_ACTIVITYTEAM} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_APPUSERREMARK} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_APPUSERMESSAGE} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_ACCOUNTFORM} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_ACCOUNTFORMVALUE} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_ACCOUNTMEDIA} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_ACTIVITYTRAVELMAPPING} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");
            ...
            db.execute("UPDATE ${TablesBase.TABLE_CONTACTMEDIA} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_OPPORTUNITYMEDIA} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_APPUSAGE} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_ACTIVITYTRAVELMEDIA} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_ACTIVITYMEDIA} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_NOTEMEDIA} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_ACCOUNTBUSINESSUNIT} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_ACTIVITYBUSINESSUNIT} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_OPPORTUNITYBUSINESSUNIT} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_ACTIVITYTRAVELEXPENSE} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_HSSUPPORTTICKET} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");

            db.execute("UPDATE ${TablesBase.TABLE_HSSUPPORTTICKETMEDIA} SET ${ColumnsBase.KEY_UPSYNCINDEX} = 1 WHERE CAST(COALESCE(${ColumnsBase.KEY_UPSYNCINDEX},100) AS INTEGER) >= ${Globals.MAX_UPSYNC_INDEX} AND  ${ColumnsBase.KEY_ISDIRTY} = 'true'");
