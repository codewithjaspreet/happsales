...
class AccountAddressBase extends BaseEntity {
  ...
  AccountAddressBase.fromMapObject(Map<String, dynamic> map) {
    accountAddressID = map['AccountAddressID'];
    accountAddressCode = map['AccountAddressCode'];
    addressTypeName = map['AddressTypeName'];
    ...
    leadQualificationID = map['LeadQualificationID'];
