...
class AccountMediaDataHandlerBase {
  static Future<List<AccountMedia>> GetAccountMediaRecordsPaged(
    ...
    try {
      ...
      String selectQuery =
          "SELECT A.* ,B.${ColumnsBase.KEY_ACCOUNT_ACCOUNTNAME},E.${ColumnsBase.KEY_CONTENTTYPE_CONTENTTYPENAME}";
      selectQuery += " FROM ${TablesBase.TABLE_ACCOUNTMEDIA} A ";
      selectQuery +=
          " LEFT JOIN ${TablesBase.TABLE_ACCOUNT} B ON A.${ColumnsBase.KEY_ACCOUNTMEDIA_ACCOUNTID} = B.${ColumnsBase.KEY_ID}";
      selectQuery +=
          " LEFT JOIN ${TablesBase.TABLE_CONTENTTYPE} E ON A.${ColumnsBase.KEY_ACCOUNTMEDIA_CONTENTTYPEID} = E.${ColumnsBase.KEY_ID}";
      selectQuery +=
          " WHERE A.${ColumnsBase.KEY_OWNERUSERID} = ${Globals.AppUserID}";
      selectQuery +=
          " AND A.${ColumnsBase.KEY_ACCOUNTMEDIA_APPUSERGROUPID} = ${Globals.AppUserGroupID}";
      selectQuery +=
          " AND LOWER(IFNULL(A.${ColumnsBase.KEY_ISDELETED},'false')) = 'false' AND LOWER(IFNULL(A.${ColumnsBase.KEY_ACCOUNTMEDIA_ISDELETED},'false')) = 'false' ";
      selectQuery +=
          " AND LOWER(IFNULL(A.${ColumnsBase.KEY_ISACTIVE},'true')) = 'true' AND LOWER(IFNULL(A.${ColumnsBase.KEY_ACCOUNTMEDIA_ISACTIVE},'true')) = 'true' ";
      selectQuery +=
          " AND LOWER(IFNULL(A.${ColumnsBase.KEY_ACCOUNTMEDIA_ISARCHIVED},'false')) = 'false' ";
      if (searchString.trim().length > 0)
        selectQuery +=
            " AND A.${ColumnsBase.KEY_ACCOUNTMEDIA_ACCOUNTMEDIANAME} LIKE '%$searchString%'";
      ...
      for (var element in result) {
        ...
        dataItem.accountMediaID =
            element[ColumnsBase.KEY_ACCOUNTMEDIA_ACCOUNTMEDIAID];
        dataItem.accountMediaCode =
            element[ColumnsBase.KEY_ACCOUNTMEDIA_ACCOUNTMEDIACODE];
        dataItem.accountMediaName =
            element[ColumnsBase.KEY_ACCOUNTMEDIA_ACCOUNTMEDIANAME];
        dataItem.accountID = element[ColumnsBase.KEY_ACCOUNTMEDIA_ACCOUNTID];
        dataItem.contentTypeID =
            element[ColumnsBase.KEY_ACCOUNTMEDIA_CONTENTTYPEID];
        dataItem.mediaPath = element[ColumnsBase.KEY_ACCOUNTMEDIA_MEDIAPATH];
        dataItem.mediaContent =
            element[ColumnsBase.KEY_ACCOUNTMEDIA_MEDIACONTENT];
        dataItem.description =
            element[ColumnsBase.KEY_ACCOUNTMEDIA_DESCRIPTION];
        dataItem.tags = element[ColumnsBase.KEY_ACCOUNTMEDIA_TAGS];
        dataItem.LocalMediaPath =
            element[ColumnsBase.KEY_ACCOUNTMEDIA_LOCALMEDIAPATH];
        ...
        dataItem.deviceIdentifier =
            element[ColumnsBase.KEY_ACCOUNTMEDIA_DEVICEIDENTIFIER];
        dataItem.referenceIdentifier =
            element[ColumnsBase.KEY_ACCOUNTMEDIA_REFERENCEIDENTIFIER];
        dataItem.isActive = element[ColumnsBase.KEY_ACCOUNTMEDIA_ISACTIVE];
        dataItem.uid = element[ColumnsBase.KEY_ACCOUNTMEDIA_UID];
        dataItem.appUserGroupID =
            element[ColumnsBase.KEY_ACCOUNTMEDIA_APPUSERGROUPID];
  ...
  static Future<List<AccountMedia>> GetAccountMediaRecords(
    ...
    try {
      ...
      if (searchString.trim().length > 0)
        selectQuery +=
            " AND A.${ColumnsBase.KEY_ACCOUNTMEDIA_ACCOUNTMEDIANAME} LIKE '$searchString%'";
      selectQuery +=
          " ORDER BY A.${ColumnsBase.KEY_ACCOUNTMEDIA_ACCOUNTMEDIANAME} COLLATE NOCASE ASC ";
  ...
  static Future<AccountMedia?> GetAccountMediaRecord(
  ...
  static Future<AccountMedia?> GetMasterAccountMediaRecord(
      DatabaseHandler databaseHandler, String id) async {
    AccountMedia? dataItem;
    try {
      id = Globals.tryParseLongForDBId(id);
      ...
      selectQuery +=
          " LEFT JOIN ${TablesBase.TABLE_CONTENTTYPE} E ON A.${ColumnsBase.KEY_ACCOUNTMEDIA_CONTENTTYPEID} = E.${ColumnsBase.KEY_ID}";
      selectQuery +=
          " WHERE A.${ColumnsBase.KEY_ACCOUNTMEDIA_ACCOUNTMEDIAID} = $id";
      selectQuery +=
          " AND A.${ColumnsBase.KEY_OWNERUSERID} = ${Globals.AppUserID}";
      selectQuery +=
          " AND A.${ColumnsBase.KEY_ACCOUNTMEDIA_APPUSERGROUPID} = ${Globals.AppUserGroupID}";
  ...
  static Future<int> AddAccountMediaRecord(
      DatabaseHandler databaseHandler, AccountMedia dataItem) async {
    int id = 0;
    try {
      final db = await databaseHandler.database;
      Map<String, dynamic> values = {};

      if (dataItem.accountMediaID != null &&
          dataItem.accountMediaID != "null") {
        values[ColumnsBase.KEY_ACCOUNTMEDIA_ACCOUNTMEDIAID] =
            dataItem.accountMediaID;
      }
      if (dataItem.accountMediaCode != null &&
          dataItem.accountMediaCode != "null") {
        values[ColumnsBase.KEY_ACCOUNTMEDIA_ACCOUNTMEDIACODE] =
            dataItem.accountMediaCode;
      }
      if (dataItem.accountMediaName != null &&
          dataItem.accountMediaName != "null") {
        values[ColumnsBase.KEY_ACCOUNTMEDIA_ACCOUNTMEDIANAME] =
            dataItem.accountMediaName;
      }
      ...
      if (dataItem.contentTypeID != null && dataItem.contentTypeID != "null") {
        values[ColumnsBase.KEY_ACCOUNTMEDIA_CONTENTTYPEID] =
            dataItem.contentTypeID;
      }
      ...
      if (dataItem.mediaContent != null && dataItem.mediaContent != "null") {
        values[ColumnsBase.KEY_ACCOUNTMEDIA_MEDIACONTENT] =
            dataItem.mediaContent;
      }
      ...
      if (dataItem.LocalMediaPath != null &&
        ...
        values[ColumnsBase.KEY_ACCOUNTMEDIA_LOCALMEDIAPATH] =
            dataItem.LocalMediaPath;
      }
      ...
      if (dataItem.deviceIdentifier != null &&
        ...
        values[ColumnsBase.KEY_ACCOUNTMEDIA_DEVICEIDENTIFIER] =
            dataItem.deviceIdentifier;
      }
      if (dataItem.referenceIdentifier != null &&
          dataItem.referenceIdentifier != "null") {
        values[ColumnsBase.KEY_ACCOUNTMEDIA_REFERENCEIDENTIFIER] =
            dataItem.referenceIdentifier;
      }
      ...
      if (dataItem.appUserGroupID != null &&
        ...
        values[ColumnsBase.KEY_ACCOUNTMEDIA_APPUSERGROUPID] =
            dataItem.appUserGroupID;
      }
  ...
  static Future<int> UpdateAccountMediaRecord(DatabaseHandler databaseHandler,
      String id1, AccountMedia dataItem) async {
    int id = 0;
    try {
      final db = await databaseHandler.database;
      Map<String, dynamic> values = {};
      ...
      id = await db.update(TablesBase.TABLE_ACCOUNTMEDIA, values,
  ...
  static Future<int> DeleteAccountMediaRecord(
      DatabaseHandler databaseHandler, String id1) async {
    int id = 0;
    try {
      final db = await databaseHandler.database;
      id = await db.delete(TablesBase.TABLE_ACCOUNTMEDIA,
          where: "${ColumnsBase.KEY_ID} = $id1", whereArgs: null);
      //db.close();
    } catch (ex) {
  ...
  static Future<List<AccountMedia>> GetAccountMediaUpSyncRecords(
      DatabaseHandler databaseHandler, String changeType) async {
    List<AccountMedia> dataList = [];
    try {
      // ignore: prefer_interpolation_to_compose_strings
      String selectQuery =
          "SELECT * FROM ${TablesBase.TABLE_ACCOUNTMEDIA} WHERE ${ColumnsBase.KEY_ISDIRTY} = 'true' AND ${ColumnsBase.KEY_UPSYNCINDEX} < ${Globals.SyncIndex}";
      ...
      selectQuery +=
          " AND ${ColumnsBase.KEY_ACCOUNTMEDIA_APPUSERGROUPID} = ${Globals.AppUserGroupID}";
      selectQuery +=
          " AND ${ColumnsBase.KEY_ACCOUNTMEDIA_ACCOUNTID} IN (SELECT  ${ColumnsBase.KEY_ID} FROM ${TablesBase.TABLE_ACCOUNT} WHERE CAST(COALESCE(${ColumnsBase.KEY_ACCOUNT_ACCOUNTID},'0') AS long) > 0)";
  ...
  static Future<AccountMedia?> GetAccountMediaRecordByUid(
