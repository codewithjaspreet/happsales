...
final db = await databaseHandler.database;
      ...
      for (var element in result) {
        ...
        // Use the dataItem object as needed
            ...
            Globals.handleException( "ActivityDataHandler:GetFollowUpActivityRecord()", ex);
            throw ex;
        }
        return dataItem;
    }

     static Future<List<Activity>> GetActivityRecordsForActivityTravel(DatabaseHandler databaseHandler,  String activityTravelId)async {
      ...
      for (var element in result) {
        ...
        dataList.add(dataItem);
            ...
            Globals.handleException( "ActivityDataHandler:GetActivityRecordsForActivityTravel()", ex);
            throw ex;
        }
        return dataList;
    }

     static Future<List<Activity>> GetActivityRecordsForTheDate(DatabaseHandler databaseHandler,  String activityDate,String accountId,String opportunityId,String contactId)async {
        List<Activity> dataList = [];
        try {
            ...
            if (accountId.trim().length > 0)
                selectQuery += " AND A." + ColumnsBase.KEY_ACCOUNT_ACCOUNTID + " = " + accountId;
      ...
      for (var element in result) {
        ...
        dataList.add(dataItem);
            ...
            Globals.handleException( "ActivityDataHandler:GetActivityRecordsForTheDate()", ex);
            throw ex;
        }
        return dataList;
    }
     ...
     static List<Activity> GetActivityRecordsPending(DatabaseHandler databaseHandler,  String activityDate) {
        ...
        try {
            ...
            selectQuery += " ORDER BY A." + ColumnsBase.KEY_ACTIVITY_ACTIVITYDATE + " DESC";
final db = await databaseHandler.database;
      ...
      for (var element in result) {
        ...
        dataList.add(dataItem);
            ...
            Globals.handleException( "ActivityDataHandler:GetActivityRecordsPending()", ex);
            throw ex;
        }
        return dataList;
    }

     static Future<List<Activity>> GetActivityRecordsForFuture(DatabaseHandler databaseHandler,  String activityDate) async{
        List<Activity> dataList = [];
        try {
            ...
            selectQuery += " ORDER BY A." + ColumnsBase.KEY_ACTIVITY_ACTIVITYDATE + " ASC";
      ...
      for (var element in result) {
        ...
        dataList.add(dataItem);
            ...
            Globals.handleException( "ActivityDataHandler:GetActivityRecordsForFuture()", ex);
            throw ex;
        }
        return dataList;
    }

     static Future<List<Activity>> GetActivityRecords(DatabaseHandler databaseHandler,  String accountId, String searchString)async {
   ...
   String activityDateTime, String activityType, String filterActivityStatus, String filterActivityStartDateTime, String filterActivityEndDateTime) {
        ...
        try {
            ...
            //NLP Filter
            if (filterActivityStartDateTime != null && !filterActivityStartDateTime.trim().equals("")
                    && filterActivityEndDateTime != null && !filterActivityEndDateTime.trim().equals("")) {

                String[] startDates = filterActivityStartDateTime.split("T");
                String[] endDates = filterActivityEndDateTime.split("T");

                if (startDates.length > 1 && endDates.length > 1) {
                    selectQuery += " AND (date(A.ActivityDate) >= date('" + startDates[0] + "') AND date(A.ActivityDate) <= date('" + endDates[0] + "')) ";
                }

            } else if (activityDateTime != null && !activityDateTime.trim().equals("")) {
                String[] dates = activityDateTime.split("T");
                if (dates.length > 1) {
      ...
      for (var element in result) {
        ...
        dataList.add(dataItem);
            ...
            Globals.handleException( "ActivityDataHandlerBase:GetActivityRecordsPagedForPlanned()", ex);
            throw ex;
        }
        return dataList;
    }

     static Future<List<Activity>> GetActivityRecordsPagedForInProcess(DatabaseHandler databaseHandler,  String searchString, String sortColumn, String sortDirection, Map<String, String> filterHashMap, int pageIndex, int pageSize, String accountId, String contactId,String opportunityId,
        ...
        try {
           ...
           if (filterActivityStartDateTime != null && filterActivityStartDateTime.trim().isNotEmpty &&
    filterActivityEndDateTime != null && filterActivityEndDateTime.trim().isNotEmpty) {
...
} else if (activityDateTime != null && activityDateTime.trim().isNotEmpty) {
...
final db = await databaseHandler.database;
      ...
      for (var element in result) {
        ...
        dataList.add(dataItem);
            ...
            Globals.handleException( "ActivityDataHandlerBase:GetActivityRecordsPagedForInProcess()", ex);
            throw ex;
        }
        return dataList;
    }

     static Future<List<Activity>> GetActivityRecordsPagedForCompleted(DatabaseHandler databaseHandler,  String searchString, String sortColumn, String sortDirection, Map<String, String> filterHashMap, int pageIndex, int pageSize, String accountId, String contactId,String opportunityId,
                                                                     String activityDateTime, String activityType, String filterActivityStatus, String filterActivityStartDateTime, String filterActivityEndDateTime) async{
        List<Activity> dataList = [];
        try {
            int startRowIndex = ((pageIndex - 1) * pageSize);
...
final db = await databaseHandler.database;
      ...
      for (var element in result) {
        ...
        dataList.add(dataItem);
            ...
            Globals.handleException( "ActivityDataHandlerBase:GetActivityRecordsPagedForCompleted()", ex);
            throw ex;
        }
        return dataList;
    }

     static Future<List<Activity>> GetActivityRecordsPagedForOthers(DatabaseHandler databaseHandler,  String searchString, String sortColumn, String sortDirection, Map<String, String> filterHashMap, int pageIndex, int pageSize, String accountId, String contactId,String opportunityId,
    String activityDateTime, String activityType, String filterActivityStatus, String filterActivityStartDateTime, String filterActivityEndDateTime) async{
        List<Activity> dataList = [];
        try {
            int startRowIndex = ((pageIndex - 1) * pageSize);
...
final db = await databaseHandler.database;
      ...
      for (var element in result) {
        ...
        dataList.add(dataItem);
            ...
            Globals.handleException( "ActivityDataHandlerBase:GetActivityRecordsPagedForOthers()", ex);
            throw ex;
        }
        return dataList;
    }
     ...
     static Future<List<Activity>> GetActivitiesForDateRange(DatabaseHandler databaseHandler,  String dateString1, String dateString2, String activityType, int recordsCount) async{
        List<Activity> dataList = [];
        try {
  ...
  selectQuery +=
      " AND (date(A.${ColumnsBase.KEY_ACTIVITY_ACTIVITYDATE}) >= '$dateString1'" +
          " OR " +
          " date(A.${ColumnsBase.KEY_ACTIVITY_ACTIVITYDATE}) >= '$dateString1') ";
}
if (dateString2.isNotEmpty) {
  selectQuery +=
      " AND (date(A.${ColumnsBase.KEY_ACTIVITY_ACTIVITYDATE}) <= '$dateString2'" +
          " OR " +
          " date(A.${ColumnsBase.KEY_ACTIVITY_ACTIVITYDATE}) <= '$dateString2') ";
}
...
final db = await databaseHandler.database;
     ...
     static Future<List<Activity>> GetActivityRecordsForCopy(DatabaseHandler databaseHandler,  String searchString, bool isPlanned, bool isInProcess, bool isCompleted, bool isOthers)async {
        List<Activity> dataList = [];
        try {
...
final db = await databaseHandler.database;
      ...
      for (var element in result) {
        ...
        dataList.add(dataItem);
            ...
            Globals.handleException( "ActivityDataHandlerBase:GetActivityRecordsForCopy()", ex);
            throw ex;
        }
        return dataList;
    }
     ...
     static Future<List<Activity>> GetParentActivityCompletedRecords(DatabaseHandler databaseHandler, String contactId, String accountId, String opportunityId, String searchString, String sortString, String activityDateTime, String activityType,
                                                            String filterActivityStatus, String filterActivityStartDateTime, String filterActivityEndDateTime) async{

        List<Activity> dataList = [];
        try {

            String selectQuery = "SELECT A.*,B." + ColumnsBase.KEY_ACTIVITYTYPE_ACTIVITYTYPENAME + ",D." + ColumnsBase.KEY_ACCOUNT_ACCOUNTNAME + ",E." + ColumnsBase.KEY_CONTACT_CONTACTNAME + ",F." + ColumnsBase.KEY_OPPORTUNITY_OPPORTUNITYNAME + ",G." + ColumnsBase.KEY_CURRENCY_CURRENCYNAME + ",C." + ColumnsBase.KEY_ACTIVITYSTATUS_ACTIVITYSTATUSNAME + ",P." + ColumnsBase.KEY_PRODUCTINSTALLATIONDETAIL_PRODUCTINSTALLATIONDETAILCODE + " FROM " + TablesBase.TABLE_ACTIVITY + " A ";
            selectQuery += " LEFT JOIN  " + TablesBase.TABLE_ACTIVITYTYPE + " B ON " + " A." + ColumnsBase.KEY_ACTIVITY_ACTIVITYTYPEID + " = B." + ColumnsBase.KEY_ID;
            selectQuery += " LEFT JOIN  " + TablesBase.TABLE_ACTIVITYSTATUS + " C ON " + " A." + ColumnsBase.KEY_ACTIVITY_ACTIVITYSTATUSID + " = C." + ColumnsBase.KEY_ID;
            selectQuery += " LEFT JOIN " + TablesBase.TABLE_ACCOUNT + " D ON A." + ColumnsBase.KEY_ACTIVITY_ACCOUNTID + " = D." + ColumnsBase.KEY_ID;
            selectQuery += " LEFT JOIN " + TablesBase.TABLE_CONTACT + " E ON A." + ColumnsBase.KEY_ACTIVITY_CONTACTID + " = E." + ColumnsBase.KEY_ID;
...
final db = await databaseHandler.database;
      ...
      for (var element in result) {
        ...
        dataList.add(dataItem);
            ...
            Globals.handleException( "ActivityDataHandler:GetParentActivityCompletedRecords()", ex);
        }
        return dataList;
    }


     static Future<List<Activity>> GetParentActivityInProcessRecords(DatabaseHandler databaseHandler, String contactId, String accountId, String opportunityId, String searchString, String sortString, String activityDateTime, String activityType,
                                                            String filterActivityStatus, String filterActivityStartDateTime, String filterActivityEndDateTime) async {
        List<Activity> dataList =[];
        try {

            String selectQuery = "SELECT A.*,B." + ColumnsBase.KEY_ACTIVITYTYPE_ACTIVITYTYPENAME + ",D." + ColumnsBase.KEY_ACCOUNT_ACCOUNTNAME + ",E." + ColumnsBase.KEY_CONTACT_CONTACTNAME + ",C." + ColumnsBase.KEY_ACTIVITYSTATUS_ACTIVITYSTATUSNAME + ",F." + ColumnsBase.KEY_OPPORTUNITY_OPPORTUNITYNAME + ",G." + ColumnsBase.KEY_CURRENCY_CURRENCYNAME + ",C." + ColumnsBase.KEY_ACTIVITYSTATUS_ACTIVITYSTATUSNAME + ",P." + ColumnsBase.KEY_PRODUCTINSTALLATIONDETAIL_PRODUCTINSTALLATIONDETAILCODE;
            selectQuery += " FROM " + TablesBase.TABLE_ACTIVITY + " A ";
            selectQuery += " LEFT JOIN  " + TablesBase.TABLE_ACTIVITYTYPE + " B ON " + " A." + ColumnsBase.KEY_ACTIVITY_ACTIVITYTYPEID + " = B." + ColumnsBase.KEY_ID;
            selectQuery += " LEFT JOIN  " + TablesBase.TABLE_ACTIVITYSTATUS + " C ON " + " A." + ColumnsBase.KEY_ACTIVITY_ACTIVITYSTATUSID + " = C." + ColumnsBase.KEY_ID;
            selectQuery += " LEFT JOIN " + TablesBase.TABLE_ACCOUNT + " D ON A." + ColumnsBase.KEY_ACTIVITY_ACCOUNTID + " = D." + ColumnsBase.KEY_ID;
...
final db = await databaseHandler.database;
      ...
      for (var element in result) {
        ...
        dataList.add(dataItem);
            ...
            Globals.handleException( "ActivityDataHandler:GetParentActivityInProcessRecords()", ex);
        }
        return dataList;
    }


     static Future<List<Activity>> GetActivityPlannedRecords(DatabaseHandler databaseHandler,String contactId, String accountId, String opportunityId, String searchString, String sortString, String activityDateTime, String activityType,
                                                    String filterActivityStatus, String filterActivityStartDateTime, String filterActivityEndDateTime) async {
        List<Activity> dataList =[];
        try {
            ...
            if (!searchString.equals("")) {
                //selectQuery += " AND " + KEY_ACTIVITY_ACTIVITYTITLE + " LIKE '%" + searchString.replaceAll("'","''") + "%'";
                selectQuery += " AND (A." + ColumnsBase.KEY_ACTIVITY_ACTIVITYTITLE  + " LIKE '%" + searchString.replaceAll("'","''") + "%'";
                selectQuery += " OR A." + ColumnsBase.KEY_ACTIVITY_ACTIVITYDETAILS + " LIKE '%" + searchString.replaceAll("'","''") + "%' ";
                selectQuery += " OR D." + ColumnsBase.KEY_ACCOUNT_ACCOUNTNAME  + " LIKE '%" + searchString.replaceAll("'","''") + "%') ";
            }
            ...
            selectQuery += " AND (C." + ColumnsBase.KEY_ACTIVITYSTATUS_ACTIVITYSTATUSNAME + " = 'Planned' OR C." + ColumnsBase.KEY_ACTIVITYSTATUS_ACTIVITYSTATUSNAME + " IS NULL)";
...
final db = await databaseHandler.database;
      ...
      for (var element in result) {
        ...
        dataList.add(dataItem);
            ...
            Globals.handleException( "ActivityDataHandler:GetActivityPlannedRecords()", ex);
        }
        return dataList;
    }


     static Future<List<Activity>> GetActivityOthersRecords(DatabaseHandler databaseHandler,String contactId, String accountId, String opportunityId, String searchString, String sortString, String activityDateTime, String activityType,
                                                           String filterActivityStatus, String filterActivityStartDateTime, String filterActivityEndDateTime) async{
        List<Activity> dataList = [];
        try {
...
final db = await databaseHandler.database;
      ...
      for (var element in result) {
        ...
        dataList.add(dataItem);
            ...
            Globals.handleException(, "ActivityDataHandler:GetActivityOthersRecords()", ex);
        }
        return dataList;
    }


     static List<Activity> GetActivityRecordsPagedForPending(DatabaseHandler databaseHandler,  String searchString, String sortColumn, String sortDirection, Map<String, String> filterHashMap, int pageIndex, int pageSize, String accountId, String contactId,String opportunityId,
                                                                     String activityDateTime, String activityType, String filterActivityStatus, String filterActivityStartDateTime, String filterActivityEndDateTime,String todayDate) {
        List<Activity> dataList = new ArrayList<Activity>();
        try {
            int startRowIndex = ((pageIndex - 1) * pageSize);
            ...
            if (cursor.moveToFirst()) {
                do {
                    Activity dataItem = new Activity();
                    dataItem.setActivityID(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_ACTIVITYID)));
                    dataItem.setActivityCode(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_ACTIVITYCODE)));
                    dataItem.setActivityTitle(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_ACTIVITYTITLE)));
                    dataItem.setActivityTypeID(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_ACTIVITYTYPEID)));
                    dataItem.setLeadSource(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_LEADSOURCE)));
                    dataItem.setAccountID(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_ACCOUNTID)));
                    dataItem.setContactID(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_CONTACTID)));
                    dataItem.setOpportunityID(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_OPPORTUNITYID)));
                    dataItem.setActivityMeasure(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_ACTIVITYMEASURE)));
                    dataItem.setActivityDate(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_ACTIVITYDATE)));
                    dataItem.setActivityEndDate(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_ACTIVITYENDDATE)));
                    dataItem.setAssignmentDetails(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_ASSIGNMENTDETAILS)));
                    dataItem.setActivityDetails(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_ACTIVITYDETAILS)));
                    dataItem.setAmountCollected(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_AMOUNTCOLLECTED)));
                    dataItem.setCurrencyID(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_CURRENCYID)));
                    dataItem.setCollectionDetails(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_COLLECTIONDETAILS)));
                    dataItem.setIsTravelled(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_ISTRAVELLED)));
                    dataItem.setTravelPurposeName(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_TRAVELPURPOSENAME)));
                    dataItem.setActivityStatusID(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_ACTIVITYSTATUSID)));
                    dataItem.setNeedFollowUpActivity(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_NEEDFOLLOWUPACTIVITY)));
                    dataItem.setParentActivityID(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_PARENTACTIVITYID)));
                    //dataItem.setParentActivityTitle(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_PARENTACTIVITYTITLE)));
                    dataItem.setActivityAssignmentID(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_ACTIVITYASSIGNMENTID)));
                    dataItem.setProductInstallationDetailID(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_PRODUCTINSTALLATIONDETAILID)));
                    dataItem.setInvoiceID(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_INVOICEID)));
                    dataItem.setWorkflowProgressID(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_WORKFLOWPROGRESSID)));
                    dataItem.setTags(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_TAGS)));
                    dataItem.setFreeTextField1(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_FREETEXTFIELD1)));
                    dataItem.setFreeTextField2(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_FREETEXTFIELD2)));
                    dataItem.setFreeTextField3(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_FREETEXTFIELD3)));
                    dataItem.setIsApproved(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_ISAPPROVED)));
                    dataItem.setMarketingContactID(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_MARKETINGCONTACTID)));
                    dataItem.setCreatedBy(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_CREATEDBY)));
                    dataItem.setCreatedOn(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_CREATEDON)));
                    dataItem.setModifiedBy(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_MODIFIEDBY)));
                    dataItem.setModifiedOn(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_MODIFIEDON)));
                    dataItem.setDeviceIdentifier(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_DEVICEIDENTIFIER)));
                    dataItem.setReferenceIdentifier(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_REFERENCEIDENTIFIER)));
                    dataItem.setLocation(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_LOCATION)));
                    dataItem.setIsActive(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_ISACTIVE)));
                    dataItem.setIsLocked(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_ISLOCKED)));
                    dataItem.setUid(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_UID)));
                    dataItem.setAppUserID(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_APPUSERID)));
                    dataItem.setAppUserGroupID(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_APPUSERGROUPID)));
                    dataItem.setIsArchived(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_ISARCHIVED)));
                    dataItem.setIsDeleted(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_ISDELETED)));

                    dataItem.setActivityTypeName(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITYTYPE_ACTIVITYTYPENAME)));
                    dataItem.setAccountName(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACCOUNT_ACCOUNTNAME)));
                    ...
                    dataItem.setCurrencyName(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_CURRENCY_CURRENCYNAME)));
                    dataItem.setActivityStatusName(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITYSTATUS_ACTIVITYSTATUSNAME)));
                    //dataItem.setParentActivityTitle(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_PARENTACTIVITYTITLE)));
                    dataItem.setProductInstallationDetailCode(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_PRODUCTINSTALLATIONDETAIL_PRODUCTINSTALLATIONDETAILCODE)));
     ...
     static List<Activity> GetActivityRecordsForSearching(DatabaseHandler databaseHandler,  String searchString) {
     ...
     static int GetCompletedActivityForTodayCount(DatabaseHandler databaseHandler, String activityDate) {
        int itemCount = 0;
        try {
           ...
           //selectQuery += " AND D." + ColumnsBase.KEY_ACTIVITYSTATUS_ACTIVITYSTATUSNAME + " = " + "'Completed'";
            ...
            Globals.handleException( "ActivityDataHandlerBase:GetActivityCompleteCount()", ex);
            throw ex;
        }
        return itemCount;
    }

     static int GetActivityRecordsByContactID(DatabaseHandler databaseHandler,  String contactId, String searchString) {
        ...
        try {
            ...
            if (searchString.trim().length() > 0)
                selectQuery += " AND A." + ColumnsBase.KEY_ACTIVITY_ACTIVITYTITLE + " LIKE '" + searchString.replaceAll("'","''") + "%'";
            if (contactId.trim().length() > 0)
                selectQuery += " AND A." + ColumnsBase.KEY_CONTACT_CONTACTID + " = " + contactId;
            selectQuery += " ORDER BY A." + ColumnsBase.KEY_ACTIVITY_TRAVELPURPOSENAME + " COLLATE NOCASE ASC ";
     ...
     static List<Activity> GetActivityRecordsForTheReminderDate(DatabaseHandler databaseHandler,  String activityDate) {
        List<Activity> dataList = new ArrayList<Activity>();
        try {
            ...
            if (cursor.moveToFirst()) {
                do {
                    ...
                    dataItem.setFreeTextField2(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_FREETEXTFIELD2)));
                    dataItem.setFreeTextField3(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_FREETEXTFIELD3)));
                    dataItem.setIsApprovalRequired(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_ISAPPROVALREQUIRED)));
                    dataItem.setIsApproved(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_ISAPPROVED)));
                    dataItem.setMarketingContactID(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_MARKETINGCONTACTID)));
                    dataItem.setCreatedBy(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_CREATEDBY)));
                    dataItem.setCreatedOn(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_CREATEDON)));
                    ...
                    dataItem.setIsArchived(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_ISARCHIVED)));
                    dataItem.setIsDeleted(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_ISDELETED)));
                    dataItem.setSuccessAlertMessage(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_SUCCESSALERTMESSAGE)));
                    dataItem.setFailureAlertMessage(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_FAILUREALERTMESSAGE)));
                    dataItem.setApprovalStatus(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_APPROVALSTATUS)));
                    dataItem.setApprovalDetails(cursor.getString(cursor.getColumnIndex(ColumnsBase.KEY_ACTIVITY_APPROVALDETAILS)));
     ...
     static List<Activity> GetActivityRecordsPagedForWeek(DatabaseHandler databaseHandler,  String searchString, String sortColumn, String sortDirection, Map<String, String> filterHashMap, int pageIndex, int pageSize, String accountId, String contactId,String opportunityId,
                                                                     String activityDateTime, String activityType, String filterActivityStatus, String filterActivityStartDateTime, String filterActivityEndDateTime,String weekStartDate,String weekEndDate) {
        List<Activity> dataList = new ArrayList<Activity>();
        try {
            int startRowIndex = ((pageIndex - 1) * pageSize);
     ...
     Future<int> getPendingActivityCountByOpportunityId(DatabaseHandler databaseHandler, String todayDate, String accountId, String opportunityId) async {
  int itemCount = 0;
  try {
    String selectQuery = "SELECT COUNT(*) ";
    selectQuery += "FROM " + TablesBase.TABLE_ACTIVITY + " A ";
  ...
  return itemCount;
    ...
    Future<int> getTodayActivityCountByOpportunityId(DatabaseHandler databaseHandler, String todayDate, String opportunityId) async {
  int itemCount = 0;
  try {
    String selectQuery = "SELECT COUNT(*) ";
    selectQuery += "FROM " + TablesBase.TABLE_ACTIVITY + " A ";
  ...
  return itemCount;
     ...
     Future<int> getWeekActivityCountByOpportunityId(DatabaseHandler databaseHandler, String accountId, String opportunityId, String weekStartDate, String weekEndDate) async {
  int itemCount = 0;
  try {
    String selectQuery = "SELECT COUNT(*) ";
    selectQuery += "FROM " + TablesBase.TABLE_ACTIVITY + " A ";
...
static Future<int> getCompletedActivityCountByOpportunityId(DatabaseHandler databaseHandler, String accountId, String opportunityId) async {
  int itemCount = 0;
  try {
    String selectQuery = "SELECT COUNT(*)";
    selectQuery += " FROM ${TablesBase.TABLE_ACTIVITY} A";
  ...
  return itemCount;
     ...
     static Future<List<Activity>> GetActivityRecordsForTodayDate(DatabaseHandler databaseHandler,  String activityDate,String accountId,String opportunityId) async {
        List<Activity> dataList = [];
        try {
